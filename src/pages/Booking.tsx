...
const Booking = () => {
  ...
  const handleBooking = async () => {
    ...
    try {
      ...
      // Insert booking into database with pending status (QR will be generated by edge function)
      ...
      // Generate cryptographically signed QR code via edge function
      const { data: qrResponse, error: qrError } = await supabase.functions.invoke(
        'generate-ticket-qr',
